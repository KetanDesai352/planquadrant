        ...
        <nav class="navigation">
                ...
                <ul class="navigation--main page-container">
                    ...
                    <li><a href="/planquadrat/people/index.php" class="navigation--main-link active">People</a>
                        <ul class="navigation--mobile-submenu visible-xs">
                            <li><a href="/planquadrat/people/partner/index.php" class="navigation--main-link">Partner</a></li>
            ...
            <div class="navigation--row hidden-xs">
                <ul class="navigation--submenu page-container">
                    <li><a href="/planquadrat/people/partner/index.php" class="navigation--submenu-link">Partner</a></li>
