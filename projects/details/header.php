        ...
        <nav class="navigation">
            ...
            <div class="navigation--row">
                <ul class="navigation--main page-container">
                    ...
                    <li><a href="/planquadrant/projects/index.php" class="navigation--main-link active">Projects</a></li>
                    <li><a href="/planquadrant/people/index.php" class="navigation--main-link">People</a></li>
                    <li><a href="/planquadrant/pin-board/news/index.php" class="navigation--main-link">Pin board</a>
